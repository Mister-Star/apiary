 ...
 */
public class TPCCLoaderopenGauss {
    ...
    public TPCCLoaderopenGauss(WorkloadConfiguration conf, Properties dbProps, String database) {
        this.conf = conf;
		this.dbProps = dbProps;
		this.database = database;
		this.workloadConfiguration = conf;
