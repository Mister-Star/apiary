...
import org.dbos.apiary.benchmarks.standaloneYCSB.procedures.XDSTExecTxnFunction;
...
public class YCSBBenchmark {
    ...
    private static final Logger logger = LoggerFactory.getLogger(YCSBBenchmark.class);
...
//        }
        ...
        Runnable r = () -> {
            ...
            try {
                ...
                if (chooser < percentageNewOrder) {
                    client.get().executeFunction("XDSTExecTxnFunction", warehouseId, conf.getNumWarehouses()).getInt();
                    if (warmed.get()) {
        ...
        printPercentile(XDSTExecTxnFunction.p1, "XDSTNewOrderFunction.p1");
        printPercentile(XDSTExecTxnFunction.p2, "XDSTNewOrderFunction.p2");
        printPercentile(XDSTExecTxnFunction.p3, "XDSTNewOrderFunction.p3");
        printPercentile(XDSTExecTxnFunction.p4, "XDSTNewOrderFunction.p4");
        printPercentile(XDSTExecTxnFunction.p5, "XDSTNewOrderFunction.p5");
    }
}
